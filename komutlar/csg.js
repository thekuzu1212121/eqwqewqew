...
exports.run = (client, message) => {
    ...
    var kasadancikanlar = [
		"Glock-18 'Fade' (**Fabrikadan yeni çıkmış**) \nDeğeri:**298.88$**",
		"M4A4 Poseidon (**Fabrikadan yeni çıkmış**) \nDeğeri:**216.11$**",
		"AK-47 Fire Serpent (**Faarikadan yeni çıkmış**) \nDeğeri:**622.62$**",
		"M4A4 Howl (**Fabrikadan  yeni çıkmış**) \nDEĞERİ:**1713.9$**",
		"M4A1-S Knight (**Fabrikadan ynei çıkmış**) \nDeğeri:**272.69$**",
		"M4A1-S Hot Rod (**Factory New**) \nPrice:**60.88$**",
		"AWP Medusa (**AMK NAPTIN EFSANESİN BÖYLE ŞANS YOKK**) \nDeğer:**1582.05$**",
		"AWP Dragon Lore (**HADİ LAN ORDAN İNANMAM :D**) \nDeğer:**1813.93$**",
		"Bayonet 'Slaugther' (**BICAKKKK :d**) \nPrice:**230.6$**",
		"M9 Bayonet 'Slaughter' (**HADİ EYW**) \nPrice:**321.3$**",
		"Karambit 'Case Hardened' (**NE DİYİM H.O**) \nPrice:**450.54$**",
		"M9 Bayonet 'Marble Fade' (**İNANILMAZ**) \nPrice:**413.2$**",
		"Bayonet 'Marble Fade' (**DEVAM KNK**) \nPrice:**288.19$**",
		"M9 Bayonet 'Bright Water' (**REKLAM:GİVEWAYS SUNUCUS SUNAR**) \nPrice:**150.5$**",
		"Karambit 'Lore' (**FABRİKADAN YENİ ÇIKMIŞ**) \nPrice:**1262.28$**",
"İNVİTE KAZANDIN '5' (**HAYIRLI OLSUN**) \nDEĞER:**5 İNVİTE KURUCUDAN AL**",
...
//Alıntı Komuttur her hangi bir telifden dolayı codare sorumlu değildir iyi günler ona göre paylaşın da...